...
import { Availability, DayAvailability } from '../RefactoredEditStaffView'; // Import from parent
...
const AvailabilityScheduler: React.FC<AvailabilitySchedulerProps> = ({ availability, onAvailabilityChange }) => {
  ...
  return (
    <div className="border border-gray-300 dark:border-gray-600 p-4 rounded-lg mb-5 bg-gray-50 dark:bg-gray-800">
      <h4 className="text-lg font-semibold text-[#664147] dark:text-[#F7C9D3] mb-4">Set Availability</h4>
      {weekDays.map(dayKey => {
        const dayConfig = availability[dayKey];
        return (
          <div key={dayKey} className="flex items-center mb-3 pb-3 border-b border-gray-200 dark:border-gray-600 last:border-b-0">
            ...
            <input
              ...
              className="ml-3 scale-110 rounded border-gray-300 dark:border-gray-600 text-[#664147] focus:ring-[#664147] dark:bg-gray-700"
            />
            {dayConfig.isAvailable && (
              <>
                <input
                  ...
                  className="ml-3 px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-[#664147] focus:border-[#664147] text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                ...
                <input
                  ...
                  className="px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-[#664147] focus:border-[#664147] text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                  disabled={!dayConfig.isAvailable}
                />
              </>
            )}
