  ...
  const sortedAndFiltered = [...filtered].sort((a, b) => {
    ...
    <div className="flex justify-center w-full min-h-[600px]">
      ...
      >        {/* Success Message Banner */}
        ...
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-[var(--color-wine)] dark:text-[#FDF6F0] mb-6">Prescription History</h2>
            {/* Error Display */}
          {error && (
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                >
              ...
              <button
                ...
                disabled={isLoading}
                className="px-4 py-2 bg-[var(--color-wine)] dark:bg-[#58383E] text-white rounded-md hover:bg-opacity-90 dark:hover:bg-[#4A2F33] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
        ...
        {!isLoading && !error && (
          <>            <div className="mb-4 text-gray-700 dark:text-gray-300 font-medium" style={{ color: 'var(--color-skyDark)' }}>
