    ...
    />
        ...
        <div>
          <div className="flex items-center justify-between mt-4 mb-4">
            <h2 className="mt-5 text-2xl sm:text-2xl font-semibold text-grayText dark:text-white mb-4 text-left">All Your Pets at a Glance:</h2>
            <div className="hidden sm:flex items-center gap-4">
              {/* Show inactive pets checkbox - hidden on mobile */}
          ...
          {/* Mobile-only checkbox and loading indicator */}
          <div className="sm:hidden mb-4 flex items-center justify-between">
            <div className="flex items-center">
              <input
                type="checkbox"
                id="showInactivePetsMobile"
                checked={showInactivePets}
                onChange={(e) => setShowInactivePets(e.target.checked)}
                className="w-5 h-5 accent-wine"
              />
              <label htmlFor="showInactivePetsMobile" className="ml-2 text-sm text-grayText dark:text-lightGrayText">
                Show inactive pets
              </label>
            </div>
            {isPetsLoading && (
