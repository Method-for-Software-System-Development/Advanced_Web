...
/**
 * Contact section component for the homepage that displays clinic contact information.
 * Includes contact details, opening hours, and an embedded Google Maps location.
 * Features a responsive layout with decorative wave divider.
 */
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0]">
                ...
                >
                    <path
                        ...
                        fill="currentColor" /* Adapts to theme colors */
            ...
            <div className="md:w-1/2 w-full flex flex-col">
                ...
                <p className="text-lg text-[#3B3B3B] mb-6 leading-relaxed">
                    ...
                    reach out or drop by- we’re always happy to help!            </p>
